...
the invocation of LINE_FILE appears. Warning: This exercise is for experts only. 
...
NB: The first two macros are neceessary to receive the value of the macro __LINE__, 
convert it into a string and then concat it to the LINE_FILE macro. Without EXPAND_MACRO, 
#__LINE__ would expand to the string "__LINE__" and not its numeric value.
*/