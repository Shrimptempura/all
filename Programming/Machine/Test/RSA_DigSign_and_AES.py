...
def main():
    ...
    message = b'Security and Python Programming, 2022 Qatar World Cup! Korea Team Fighting!!'
...
#    key = string.ascii_uppercase + "123456"
#    iv = string.ascii_lowercase[:16]
    #key = key.encode()
    #iv = iv.encode()
    print("key: ", key)
    print("key length(bytes): ", len(key))
    print("IV: ", iv)
    print("iv length(bytes): ", len(iv))
